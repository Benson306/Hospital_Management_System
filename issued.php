...
<div class='body'>
       <nav>
           <ul>
                ...
                <li><a href='#'></a></li>
               <li><a href='#.php'>Issue Out Equipment/Drugs</a></li>
     ...
     <!--  <button class="btn btn-danger" style='margin-left: 10%;' onclick="goBack()">Go Back</button>
      ...
      window.history.back();
        ...
        <br>
       <br>
       <div class='well well-sm' id='ribbon'><h3>Record Equipments/Drugs That you Have Issued Out to Staff:</h3></div>
       <div class='tabs'>
       <div class='details_form'>
            ...
            <label>Type of Item:</label>
                ...
                <br>
                <label>Issued To: (Name of Receiver)</label>
                <input type='text' class='form-control' placeholder="Receiver's Name" name='receiver' required='yes'>
                <br>
                <label>Date:</label>
...
if(isset($_POST['submit'])){
    ...
    $sql1 = "INSERT INTO store_received(name, quantity, type, received_from, received_by, issued_to, issued_by, date) VALUES('$name', '$quantity', '$type', '', '', '$receiver', '$username', '$date')";
