...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js"></script>  
    ...
    <title>Hospital ERP -Admin</title>
</head>
<body>
<div class='body'>
       <nav>
    ...
    <script>
      ...
      <br>
       ...
       <div class='well well-sm' id='ribbon'><h3>Print Patient's Individual Report of Current Visit</h3></div>
       <br>
       <div class='tabs'>
                         ...
                         $sql3 = "SELECT * FROM patients_details ORDER BY regDate DESC";
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td><a href='current.php?patientPDF_id=$row[patient_id]' style='color: black;'class='btn btn-success'>Print Report</a></td>    
                               </tr>  
                               "; 
...
if(isset($_GET['patientPDF_id'])){
    ...
    <script>window.location="currentPDF.php"</script>
    <?php
}
