...
<div class='body'>
    ...
    <script>
      ...
      <br>
       ...
       <div class='well well-sm' id='ribbon'><h3>Print Patient's Individual Report of All Their Visits</h3></div>
       <br>
       <div class='tabs'>
                         ...
                         $sql3 = "SELECT * FROM patients_details ORDER BY regDate DESC";
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td><a href='patient_report.php?patientPDF_id=$row[patient_id]' style='color: black;'class='btn btn-success'>Print Report</a></td>    
                               </tr>  
                               "; 
